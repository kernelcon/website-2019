        ...
        <div className='container'>
          <div className='venue-section'>
            ...
            <div className='text-block'>
              <h3 className='highlight-text'>We can’t have the best con in the region without the best speakers.  We need your help.</h3>
              ...
              <h3 className='tab-title'>The Kernelcon Call for Papers will be opening soon.</h3>
            </div>
          </div>
        </div>
      </div>
