        ...
        <div className='container'>
          <div className='venue-section'>
            ...
            <div className='text-block'>
              ...
              <p>CFP will close Jan 25, 2019</p>
              <p>CFP submitters will be notified Feb 4, 2019</p>
              ...
              <p>If your talk doesn't fit precisely into one of these areas, but you still think is a good fit, please submit it for consideration!  The suggested topics are meant only to provide some direction, not as a strict pedantic gate through which all submissions must pass.</p>
              <h3 className='tab-title'>Conference format</h3>
              <p>Kernelcon has two, concurrent main tracks, and talks should fit into a 60 or 20 minute timeslot (meaning a 15 or 50 minute presentation is expected).  As one might expect, presenters will be positioned at the front of a hotel conference area, and will present using typical conference equipment.</p>
              <h3 className='tab-title'p>Speaker Benefits</h3>
              <p>Speakers receive complimentary admission to Kernelcon and will be recognized as a speaker via a special speaker badge.  Speakers also have the option of attending an exclusive speaker party preceding the conference.  Details will be sent to accepted speakers following acceptance notification.</p>
              <p>We may also tentatively accept backup/alternate talks which will not be guaranteed a speaking slot, but will receive admission in order to be ready to present in the event they are needed.</p>
              <h3 className='tab-title'p>How to submit</h3>
              <p>Speakers should submit directly (e.g. no PR representatives are permitted).</p>
              <ul>
                <li>Your submission email should include:</li>
              ...
              <p>*These should be copied directly from your attached file.</p>
              ...
              <p>Templates are available in <a href={plaintext} download>plaintext</a>, <a href="#" download>markdown</a>, <a href={docx} download>docx</a>, <a href={odt} download>odt</a>, and <a href={tex} download>LaTeX</a>.</p>
              ...
              <p>As detailed above, I, (insert primary speaker name), have read and agree to the Grant of Copyright Use. </p>
              <p>I, (insert primary speaker name), have read and agree to the Terms of Speaking Requirements. </p>
            </div>
          </div>
        </div>
      </div>
